...
export const translations = {
  en: {
    ...
    helplineDesc: "Toll-free national voter helpline number (1950).",
    voterApp: "Voter Helpline App",
    voterAppDesc: "Check your name, find booth, and download e-EPIC.",
    cVigil: "cVIGIL App",
    cVigilDesc: "Report election code violations in real-time.",
  ...
  hi: {
    ...
    // Official Tools
    officialTools: "आधिकारिक ईसीआई उपकरण",
    officialToolsSub: "भारत निर्वाचन आयोग के आधिकारिक संसाधन।",
    helplineTitle: "वोटर हेल्पलाइन",
    helplineDesc: "टोल-फ्री राष्ट्रीय मतदाता हेल्पलाइन नंबर (1950)।",
    voterApp: "वोटर हेल्पलाइन ऐप",
    voterAppDesc: "अपना नाम जांचें, बूथ खोजें और ई-एपिक डाउनलोड करें।",
    cVigil: "cVIGIL ऐप",
    cVigilDesc: "वास्तविक समय में चुनाव आचार संहिता के उल्लंघन की रिपोर्ट करें।",
